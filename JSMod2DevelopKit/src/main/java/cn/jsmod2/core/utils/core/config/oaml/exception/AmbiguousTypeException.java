 ...
 * 
 */
package cn.jsmod2.core.utils.core.config.oaml.exception;
/**
 * When you read an object and find that the value
 * is not an  object type,you can not convert it,it will
 * throw this excption , indicating the object type or
 * other types of unclear problems.
 * @author magiclu550
 * @since JDK1.8
 * @since oaml 002
 *
...
public class AmbiguousTypeException extends RuntimeException{
	...
	public AmbiguousTypeException(String message, Throwable cause, boolean enableSuppression,
