...
/**
 * Used to detect syntax errors encountered by
 * the parser during parsing.When the parser encounters
 * a syntax error,it throws the exception and indicates
 * the number of error lines and the error location and 
