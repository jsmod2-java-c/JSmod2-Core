...
import cn.jsmod2.core.utils.core.config.oaml.DocumentFactory;
import cn.jsmod2.core.utils.core.config.oaml.OamlReader;
import cn.jsmod2.core.utils.core.config.oaml.OamlWriter;
...
public class OamlConfig extends Config {
	...
	/**
	 * it is used to save the cn.jsmod2.config ,like the write,write into
	 * the target file.
	...
	/**
	 * This method can close the cn.jsmod2.config stream
	 */
	...
	/**
	 * This method can get the document object of this cn.jsmod2.config
